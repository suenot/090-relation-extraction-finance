# Chapter 252: Relation Extraction Finance

## Описание

Извлечение отношений из финансовых текстов.
...
1. **Financial Relation Extraction Using Neural Networks**
   - URL: https://arxiv.org/abs/2108.03556
   - Год: 2021

## Структура
```
252_relation_extraction_finance/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
